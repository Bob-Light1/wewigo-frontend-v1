    ...
    <div className='relative h-full overflow-y-scroll bg-gray-50 p-6'>
      <div className='max-w-3xl mx-auto'>
        ...
        <div className='bg-white rounded-2xl shadow overflow-hidden'>
          ...
          {/* Cover Photo*/}
          <div className='h-40 md:h-56 bg-gradient-to-r from-[#346faa] via-[#397cbe] to-pink-200'>
            {
            user.cover_photo && 
            <img src={user.cover_photo} alt={user.username} className='w-full h-full object-cover'/>
            }
          </div>
              ...
              {["posts", "media", "likes"].map((tab) =>(
                <button 
                  ...
                  className={`flex-1 px-4 py-2 text-sm font-medium rounded-lg transition-colors cursor-pointer
                    ${activeTab === tab ? "bg-[#397cbe] text-white" : "text-gray-600 hover:text-gray-900"}`}
                >
