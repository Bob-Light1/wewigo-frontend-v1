...
const Connections = () => {
  ...
  return (
    <div className='h-full bg-slate-50 overflow-y-scroll no-scrollbar py-10 xl:pr-5 flex items-start justify-center xl:gap-8'>
      ...
      <div className='max-w-3xl mx-auto p-6'>
        ...
        <div className='mb-8 flex flex-col items-center justify-center lg:items-start'>
          ...
          <p className='text-slate-600 text-center'>Manage your network and discover new connections</p>
        </div>

        {/* Counts*/}
        <div className='mb-8 flex flex-wrap gap-6 items-center justify-center lg:items-start'>
        ...
        <div className='inline-flex flex-wrap items-center justify-center border border-gray-200 rounded-md p-1 bg-white shadow-sm'>
          {dataArray.map((tab) => (
            <button 
              key={tab.label}
        ...
        {/* Connections */}
        <div className='w-full flex flex-wrap justify-center lg:justify-start gap-4 mt-6'>
          {dataArray.find((item) => item.label === currentTab).value.map((user) => (
            ...
            >
              <img 
                ...
                alt=''
                className='rounded-ful w-12 h-12 shadow-md mx-auto'
              />
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  {
                    <button 
                      ...
                      className='w-full p-2 text-sm rounded bg-gradient-to-r from-[#346faa] to-[#4989c8] 
                      hover:from-[#3A6FA5] hover:to-[#2E587F] active:scale-95 transition text-white cursor-pointer'
                    >
                      View Profile
                    </button>
                  }
