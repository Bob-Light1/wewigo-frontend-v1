      ...
      <div className='flex gap-4 pb-5'>
        ...
        <div 
            ...
            className='rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-[3/4] cursor-pointer
                     hover:shadow-lg transition-all duration-200 border-2 border-dashed border-[#A9C9E8] 
                    bg-gradient-to-b from-[#F2F8FD] to-white'
        >
           
            <div className='h-full flex flex-col items-center justify-center p-4'>
                <div className='size-10 bg-[#4989C8] rounded-full flex items-center justify-center mb-3'>
        ...
        {/* Story Cards*/}
        {
            stories.map((story, index) => (
                <div 
                    ...
                    hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-[#5798d9] to-[#1a3c5e] 
                    hover:from-[#3A6FA5] hover:to-[#2E587F] active:scale-95`}
                >
                            ...
                            <div className='absolute inset-0 z-1 rounded-lg bg-black overflow-hidden'>
                                {
                                    ...
                                    <video src={story.media_url} 
                                           className='h-ful w-full object-cover hover:scale-110 transition duration-500 opacity-70 hover:opacity-80'
                                    />
                                }
                            </div>
                        )
