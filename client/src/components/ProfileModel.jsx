            ...
            <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                        ...
                        <div className='group/cover relative'>
                            <img 
                                ...
                                className='w-80 h-40 rounded-lg bg-gradient-to-r from-[#ffa171] via-purple-200 to-[#ff7f3e] object-cover mt-2'
                                alt="" 
                            />
                ...
                <div>
                    ...
                    <textarea
                        rows={3}
                        className='w-full p-3 border border-gray-200 rounded-lg'
                        placeholder='Please enter a short biography'
                ...
                <div className='flex justify-end space-x-3 pt-6'>
                    ...
                    <button 
                        type='submit'
                        className='px-4 py-2 bg-gradient-to-r from-[#ff7f3e] to-[#ff6e25] text-white rounded-lg 
                        hover:from-[#ff6e25] to-[#ff5d0b] transition cursor-pointer'
                    >
                        Save Changes
                    </button>
                </div>
