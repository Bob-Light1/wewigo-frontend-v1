...
const StoryModal = ({setShowModal, fetchStories}) => {
    ...
    const bgColors = ["#4f46e5", "#7c3aed", "#db2777", "#e11d48", "#ca8a04", 
                      "#0d9488", "#003235", "#4989c8", "#001f52", "#ff7f3e", 
                      "#0045b8", "#ef6fae", "#2e6397", "#1f4972", "#70a2d4"]
  ...
  return (
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white
      ...
      <div className='w-full max-w-md'>
        ...
        <div className='rounded-lg h-95 flex items-center justify-center relative' style={{backgroundColor:background}}>
            {mode === 'text' && (
                <textarea 
        ...
        <button 
            onClick={() =>  toast.promise(handleCreateStory(), {
                loading: 'Saving...',
                success: <p>Story Added Successfullyy</p>,
                error: e => <p>{e.message}</p>,
            })}
            className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded
            bg-gradient-to-r from-[#003285] to-[#4989c8] hover:from-[#00286c] hover:to-[#397cbe] 
